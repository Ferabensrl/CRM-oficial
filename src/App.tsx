...
import { Users, FileText, DollarSign, BarChart3, LogOut, Menu, X, Download, FileDown } from 'lucide-react';
...
const MovimientosView: React.FC<{ movimientos: Movimiento[]; onRefresh: () => void }> = () => (
  <div>
